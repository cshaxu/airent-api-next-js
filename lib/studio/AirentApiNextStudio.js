...
function resolveDocumentColor(values) {
...
function buildStudioPalette() {
    ...
    const surface = (_a = resolveDocumentColor([
    ...
    ])) !== null && _a !== void 0 ? _a : parseColor(DEFAULT_STUDIO_PALETTE.surface);
    const text = (_b = resolveDocumentColor([
        bodyStyle.color,
        rootStyle.color,
    ...
    ])) !== null && _b !== void 0 ? _b : parseColor(DEFAULT_STUDIO_PALETTE.text);
...
function palettesMatch(left, right) {
    return (left.isDark === right.isDark &&
...
function AirentApiNextStudioView({ groups }) {
    ...
    const [palette, setPalette] = (0, react_1.useState)(DEFAULT_STUDIO_PALETTE);
    ...
    const styles = (0, react_1.useMemo)(() => buildStyles(palette), [palette]);
    ...
    const [requestStartedAt, setRequestStartedAt] = (0, react_1.useState)(null);
    const [requestElapsedSeconds, setRequestElapsedSeconds] = (0, react_1.useState)(0);
    ...
    const responseStatusLabel = requestPhase === "idle"
        ...
        : requestPhase === "pending"
            ...
            : requestPhase === "success"
                ? `Success (${(_e = responseState === null || responseState === void 0 ? void 0 : responseState.status) !== null && _e !== void 0 ? _e : "unknown"}, ${requestElapsedSeconds}s)`
                : (responseState === null || responseState === void 0 ? void 0 : responseState.status)
